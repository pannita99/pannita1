...
<div class="ml-64 p-6">
  <h2 class="text-purple-400 text-2xl mb-4">จัดการสินค้า</h2>
  ...
  <form action="kadd_product.php" method="POST" class="bg-gray-800 p-4 rounded mb-6">
    ...
    <button type="submit" class="bg-purple-500 text-black px-4 py-2 rounded">+ เพิ่มสินค้า</button>
  </form>
  ...
  <table class="w-full bg-gray-800 rounded">
    ...
    <tr class="border-b border-gray-700">
      ...
      <td class="p-3 text-purple-400">฿<?= $row['price']; ?></td>

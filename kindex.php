...
<head>
  <meta charset="UTF-8">
  <title>Italian Admin Dashboard  พัณณิตา สุขรักษา</title>
...
<div class="ml-64 p-6">
  <h1 class="text-purple-400 text-3xl font-bold mb-6">📊 ภาพรวม</h1>
  ...
  <div class="grid grid-cols-3 gap-6">
    <div class="bg-gray-800 p-6 rounded shadow">
      ...
      <p class="text-3xl text-purple-400"><?= $countProducts; ?></p>
    </div>
    <div class="bg-gray-800 p-6 rounded shadow">
      <h2 class="text-lg">👥 ผู้ใช้</h2>
      <p class="text-3xl text-purple-400"><?= $countUsers; ?></p>
    </div>
    <div class="bg-gray-800 p-6 rounded shadow">
      <h2 class="text-lg">📋 ออเดอร์</h2>
      <p class="text-3xl text-purple-400"><?= $countOrders; ?></p>
    </div>
  </div>

  <div class="mt-10">
    <h2 class="text-purple-400 text-xl mb-4">🆕 ออเดอร์ล่าสุด</h2>
    <table class="w-full bg-gray-800 rounded">
      ...
      <tr class="border-b border-gray-700">
        ...
        <td class="p-3 text-purple-400">฿<?= $row['total']; ?></td>
